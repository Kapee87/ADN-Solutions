...
export default function Solutions() {
    ...
    return (
        <section id="soluciones"
            ...
            [&>div>h3]:text-2xl [&>div>h3]:font-primary [&>div>h3]:mb-4

            [&>div>p]:font-bold
            `}>

            <div className="solucion">
                <h3><TextGradient >Diseño Web Responsivo</TextGradient></h3>
            ...
            <div className="solucion">
                <h3><TextGradient >Desarrollo de Aplicaciones Web</TextGradient></h3>
            ...
            <div className="solucion">
                <h3><TextGradient >Optimización SEO</TextGradient></h3>
